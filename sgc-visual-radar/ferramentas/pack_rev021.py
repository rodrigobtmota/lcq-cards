# -*- coding: utf-8 -*-
"""Empacotamento da REV02.1: msapp, pacote de importacao e fontes auditaveis."""
...
DIST = caminhos.saida('dist_rev02_1')
MSAPP = os.path.join(DIST, 'SGC_LCQ_RJ_VISUAL_RADAR_REV02_1.msapp')
PKG = os.path.join(DIST, 'SGC_LCQ_RJ_VISUAL_RADAR_REV02_1_IMPORT.zip')
FONTES = os.path.join(DIST, 'SGC_LCQ_RJ_VISUAL_RADAR_REV02_1_FONTES.zip')
